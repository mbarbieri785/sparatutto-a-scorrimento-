...
let benedetta: Sprite = null
let projectile: Sprite = null
let tommy: Sprite = null
scene.setBackgroundColor(9)
scene.setBackgroundImage(assets.image`road`)
tommy = sprites.create(assets.image`tommy`, SpriteKind.Player)
tommy.setPosition(155, 66)
controller.moveSprite(tommy, 50, 50)
tommy.setStayInScreen(true)
game.onUpdateInterval(randint(1000, 2000), function () {
    benedetta = sprites.create(img`
        ........................
        ........................
        ...........ccc..........
        ...........cccc.........
        ...
        ........cccccccc........
        `, SpriteKind.Enemy)
    benedetta.setPosition(0, randint(20, 100))
    benedetta.setVelocity(50, 0)
})
